...
const App: React.FC = () => {
  ...
  const [headerTitle, setHeaderTitle] = useState("Conversation"); // Add state for header title
  ...
  useEffect(() => {
    scrollToBottom();
    // Update title based on messages or loading state
    setHeaderTitle("Conversation"); // Always "Conversation" for the main app
  }, [messages, isLoading]);
  ...
  const examplePrompts = [
    "최근 1주간 삼성전자 주식 시장 동향",
    "최근 1주간 AI 관련 기술 요점정리",
    "최근 1개원간 산업자원통산부 주요 소식 5가지",
  ];
